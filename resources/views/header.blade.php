...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li><a href="/admin/record"><em class="fa fa-navicon">&nbsp;</em> Manage Book Record</a></li>


        <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
            <em class="fa fa-navicon">&nbsp;</em> Export Data <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
            </a>
            <ul class="children collapse" id="sub-item-2">
                <li><a class="" href="/admin/viewuserexcel">
                    <span class="fa fa-arrow-right">&nbsp;</span> Export By User
                </a></li>
                <li><a class="" href="/admin/range">
                    <span class="fa fa-arrow-right">&nbsp;</span> Export By Date
                </a></li>
            </ul>
        </li>
