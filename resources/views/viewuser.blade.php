...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="/admin/viewuser"><em class="fa fa-navicon">&nbsp;</em> Manage User</a></li>
			...
			<div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <tr align="center">
                        ...
                        <td>{{ $datas['name'] }}</td>
                        <td>{{ $datas['email'] }}</td>
                        <td><a href="/admin/edituser/{{ $datas['id'] }}" class="btn btn-primary">Edit</a> <a href="/admin/deleteuser/{{ $datas['id'] }}" class="btn btn-danger">Delete</a></td>
                    </tr>
                    @php
                    $id++;
                    @endphp
