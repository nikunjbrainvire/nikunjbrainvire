	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Return Book Record</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Return Book Record</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <tr align="center">
                        ...
                        <td><a href="/admin/returneditbookrecord/{{ $datas->id }}" class="btn btn-primary" ><i class="fa fa-pencil-square-o" aria-hidden="true" ></i> Edit</a> </td>
                    </tr>
                    @php
                    $id++;
                    @endphp
