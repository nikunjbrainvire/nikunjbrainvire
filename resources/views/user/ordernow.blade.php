...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li><a href="#"><em class="fa fa-navicon">&nbsp;</em> My Orders</a></li>
                ...
                <div class="col-md-12">
                    ...
                    @endif
                        ...
                        <div class="row test" style="border: solid 1px;"><br>
                            ...
                            {{-- <a href="/user/deletecart/{{ $datas->id }}" style="float: right;margin:5px;font-size:15px;" class="btn btn-danger" type="submit">Delete</a> --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <form action="/user/ordernow" method="post">
                                    @csrf
                                <table class="table">
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea name='address' style="height: 100px;width :300px;;">{{ old('address') }}</textarea></td>
                                    </tr>
                                    <tr>
                                        <td><h3><b>Payment Method:-</b></h3></td>
                                        <td><input type="radio" name="payment" value="1"> Cash On Delivery<br>
                                            <input type="radio" name="payment" value="2"> Online Payment
                                        </td>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="hidden" name="value" value="{{ $r }}">
                            <button style="float: right;margin:5px;font-size:20px;" class="btn btn-primary" type="submit">Order Now </button>
